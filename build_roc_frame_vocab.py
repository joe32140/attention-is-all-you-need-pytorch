...
def build_vocab(text, threshold, paragraph):
    ...
    for i, entry in enumerate(dialog):
        ...
        if args.parse:
            ...
            frames = dialog[entry]['mapped_seq']
        print("frames", frames)
...
def main(args):
    ...
    vocab_path = os.path.join(args.vocab_dir, 'ROC_Story_frame_vocab.pkl')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--caption_path', type=str,
                        default="/home/cloud60138/data/ROC_Story_with_frame_lu_filtered.json",
